...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void createTables(SQLiteDatabase database) {
		String account_table_sql = "create table "
				+ Database.ACCOUNTS_TABLE_NAME + " ( " + Database.ACCOUNTS_ID
				+ " integer  primary key autoincrement,"
				+ Database.ACCOUNTS_ACNO + " TEXT," + Database.ACCOUNTS_HOLDERS
				+ " TEXT," + Database.ACCOUNTS_CNO + " TEXT,"
				+ Database.ACCOUNTS_BANK + " TEXT," + Database.ACCOUNTS_BRANCH
				+ " TEXT," + Database.ACCOUNTS_ADDRESS + " TEXT,"
				+ Database.ACCOUNTS_IFSC + " TEXT," + Database.ACCOUNTS_MICR
				+ " TEXT," + Database.ACCOUNTS_BALANCE + " FLOAT,"
